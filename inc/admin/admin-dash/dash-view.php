...
<section class="dash">
  ...
  <section class="dash-cards">
    ...
    <article class="dash-card">
      <a class="dash-card__link" href="<?php echo admin_url( 'edit.php?post_type=film' ); ?>">
        <div class="dash-card__content">
          <i class="dash-card__icon icon-eye"></i>

          <h3 class="dash-card__title">Films / Work</h3>

          <p class="dash-card__text">Manage your sorry-ass projects. </p>
        </div>
      </a>
    </article>

    <article class="dash-card">
      <a class="dash-card__link" href="<?php echo admin_url( 'edit.php?post_type=photo' ); ?>">
        <div class="dash-card__content">
          <i class="dash-card__icon icon-camera"></i>

          <h3 class="dash-card__title">Photos</h3>

          <p class="dash-card__text">Manage your hipster photography. </p>
        </div>
      </a>
    </article>
    ...
    <article class="dash-card">
      <a class="dash-card__link" href="<?php echo admin_url( 'edit.php' ); ?>">
        <div class="dash-card__content">
          ...
          <h3 class="dash-card__title">Stories</h3>
